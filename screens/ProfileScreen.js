...
import { Text, Headline, Paragraph, Divider, Avatar, Subheading, Caption } from "react-native-paper"
    ...
    return (
        <ScrollView style={{ backgroundColor: "#fff" }}>
            ...
            <View style={styles.bodyBlock}>
                <Subheading style={{ paddingTop: 12, fontWeight: "bold" }}>Thông tin cơ bản</Subheading>
                ...
                <Subheading style={{ paddingTop: 12, fontWeight: "bold" }}>Thông tin liên lạc</Subheading>
                <View style={styles.detailBlock}>
